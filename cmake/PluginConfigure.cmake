...
if ("${PKG_TARGET}" STREQUAL "flatpak")
  set(PKG_TARGET_FULL "${PKG_TARGET}${PKG_TARGET_ARCH}")
  if (NOT "${PKG_TARGET_WX_VER}" STREQUAL "")
    string(REGEX REPLACE "^-" "" PKG_TARGET_WX_VERSION "${PKG_TARGET_WX_VER}")
    set(PKG_TARGET_FULL "${PKG_TARGET_FULL}-wx${PKG_TARGET_WX_VERSION}")
  endif ()
else ()
  set(PKG_TARGET_FULL
